...
export default function Green() {
  return (
    <div className="m-3.5">
      ...
      <p>
        My house has solar panels and we also store that energy in battieries in
        case of a power outage.
      </p>
      <p>
        I always love seeing cool sustainibility and green projects. If you find
        one or are working on one, please let me know! My contact info is on the{" "}
